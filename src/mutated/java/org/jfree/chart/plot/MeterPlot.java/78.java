/* LittleDarwin generated mutant
 ...
 ----> before: area   . getHeight  ( )  - gapVertical    + ( ( this   . meterAngle  <= 180     )   && ( this   . shape  != DialShape   . CIRCLE   )    ? area   . getHeight  ( )  / 1.25     : 0     )   
----> after: area   . getHeight  ( )  - gapVertical    - ( ( this   . meterAngle  <= 180     )   && ( this   . shape  != DialShape   . CIRCLE   )    ? area   . getHeight  ( )  / 1.25     : 0     )   
