/* LittleDarwin generated mutant
 ...
 ----> before: bounds   . getWidth  ( )  <= widthRange   . getUpperBound  ( )   && bounds   . getHeight  ( )  <= heightRange   . getUpperBound  ( )   
----> after: bounds   . getWidth  ( )  <= widthRange   . getUpperBound  ( )   || bounds   . getHeight  ( )  <= heightRange   . getUpperBound  ( )   
