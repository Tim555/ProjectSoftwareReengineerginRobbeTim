/* LittleDarwin generated mutant
 ...
 ----> before: frame   . getCenterY  ( )  - rect   . getHeight  ( )  / 2.0     
----> after: frame   . getCenterY  ( )  + rect   . getHeight  ( )  / 2.0     
...
package org . jfree . chart . ui  ;
 ...
 public  final  class Align { public   static   final   int   CENTER  = 0x00       ;
   ...
   private   Align ( )  { super   ( )   ;
  }      public   static   void align ( Rectangle2D   rect   , Rectangle2D   frame   , int   align    )  { double   x  = frame   . getCenterX  ( )  - rect   . getWidth  ( )  / 2.0          ;
  ...
  }     if ( ( align   & BOTTOM    )   == BOTTOM    )  { y   = frame   . getMaxY  ( )  - h      ;
  }     if ( ( align   & LEFT    )   == LEFT    )  { x   = frame   . getX  ( )    ;
  }     if ( ( align   & RIGHT    )   == RIGHT    )  { x   = frame   . getMaxX  ( )  - w      ;
