/* LittleDarwin generated mutant
 ...
 ----> before: size   . getHeight  ( )  - insets   . top   - insets   . bottom  
----> after: size   . getHeight  ( )  - insets   . top   + insets   . bottom  
...
package org . jfree . chart . ui  ;
 ...
 public  class StrokeSample extends JComponent   implements ListCellRenderer    { private   Stroke   stroke    ;
   private   Dimension   preferredSize    ;
   public   StrokeSample ( Stroke   stroke    )  { this   . stroke  = stroke     ;
  ...
  if ( this   . stroke  != null     )  { g2   . setStroke  ( this   . stroke   )   ;
  g2   . draw  ( line    )   ;
  }     }      @ Override      public   Component   getListCellRendererComponent ( JList   list   , Object   value   , int   index   , boolean   isSelected   , boolean   cellHasFocus    )  { if ( value   instanceof Stroke    )  { setStroke   ( ( Stroke   ) value     )   ;
  }   else { setStroke   ( null     )   ;
  }     return this   ;
  }      }      