/* LittleDarwin generated mutant
 ...
 ----> before: Modifier   . isPublic  ( f   . getModifiers  ( )   )  && Modifier   . isFinal  ( f   . getModifiers  ( )   )   && Modifier   . isStatic  ( f   . getModifiers  ( )   )  
----> after: Modifier   . isPublic  ( f   . getModifiers  ( )   )  && Modifier   . isFinal  ( f   . getModifiers  ( )   )   || Modifier   . isStatic  ( f   . getModifiers  ( )   )  
