/* LittleDarwin generated mutant
 ...
 ----> before: minY   + ( plotArea   . getHeight  ( )  * 0.8     )   
----> after: minY   - ( plotArea   . getHeight  ( )  * 0.8     )   
...
package org . jfree . chart . needle  ;
 ...
 public  class LongNeedle extends MeterNeedle   implements Cloneable   , Serializable    { private   static   final   long   serialVersionUID  = - 4319985779783688159L        ;
   public   LongNeedle ( )  { super   ( )   ;
  setRotateY   ( 0.8     )   ;
  }      @ Override      protected   void drawNeedle ( Graphics2D   g2   , Rectangle2D   plotArea   , Point2D   rotate   , double   angle    )  { GeneralPath   shape1  = new GeneralPath  ( )         ;
  ...
  }     if ( ! ( obj   instanceof LongNeedle    )    )  { return false    ;
