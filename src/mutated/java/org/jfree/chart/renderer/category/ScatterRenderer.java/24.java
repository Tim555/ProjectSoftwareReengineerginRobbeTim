/* LittleDarwin generated mutant
 ...
 ----> before: ! ObjectUtils   . equal  ( this   . seriesShapesFilled  , that   . seriesShapesFilled   )  
----> after:   ObjectUtils   . equal  ( this   . seriesShapesFilled  , that   . seriesShapesFilled   )  
...
package org . jfree . chart . renderer . category  ;
 ...
 public  class ScatterRenderer extends AbstractCategoryItemRenderer   implements Cloneable   , PublicCloneable   , Serializable    { private   BooleanList   seriesShapesFilled    ;
   ...
   public   ScatterRenderer ( )  { this   . seriesShapesFilled  = new BooleanList  ( )       ;
  ...
  fireChangeEvent   ( )   ;
  }      public   void setSeriesShapesFilled ( int   series   , boolean   filled    )  { this   . seriesShapesFilled  . setBoolean  ( series   , Boolean   . valueOf  ( filled    )   )   ;
  fireChangeEvent   ( )   ;
...
i   ++     ) { double   x1     ;
  ...
  }      if ( getItemShapeFilled   ( row   , column    )  )  { if ( this   . useFillPaint  )  { g2   . setPaint  ( getItemFillPaint   ( row   , column    )   )   ;
  ...
  }     if ( ! ( obj   instanceof ScatterRenderer    )    )  { return false    ;
  ...
  }      @ Override      public   Object   clone ( )  throws CloneNotSupportedException   { ScatterRenderer   clone  = ( ScatterRenderer   ) super   . clone  ( )       ;
