/* LittleDarwin generated mutant
 ...
 ----> before: t   != null     && itemPaint   instanceof GradientPaint    
----> after: t   != null     || itemPaint   instanceof GradientPaint    
...
package org . jfree . chart . renderer . category  ;
 ...
 public  class StandardBarPainter implements BarPainter   , Serializable    { public   StandardBarPainter ( )  { }      @ Override      public   void paintBar ( Graphics2D   g2   , BarRenderer   renderer   , int   row   , int   column   , RectangularShape   bar   , RectangleEdge   base    )  { Paint   itemPaint  = renderer   . getItemPaint  ( row   , column    )      ;
  ...
  g2   . setPaint  ( paint    )   ;
  g2   . draw  ( bar    )   ;
  }     }     }      @ Override      public   void paintBarShadow ( Graphics2D   g2   , BarRenderer   renderer   , int   row   , int   column   , RectangularShape   bar   , RectangleEdge   base   , boolean   pegShadow    )  { Paint   itemPaint  = renderer   . getItemPaint  ( row   , column    )      ;
  ...
  }     if ( ! ( obj   instanceof StandardBarPainter    )    )  { return false    ;
  }     return true    ;
