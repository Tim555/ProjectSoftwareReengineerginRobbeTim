/* LittleDarwin generated mutant
 ...
 ----> before: ( yyAverage   >( dataArea   . getMinY  ( )  - aRadius    )    )   && ( yyAverage   <( dataArea   . getMaxY  ( )  + aRadius    )    )   
----> after: ( yyAverage   >( dataArea   . getMinY  ( )  - aRadius    )    )   || ( yyAverage   <( dataArea   . getMaxY  ( )  + aRadius    )    )   
----> line number in original file: 873
----> mutated nodes: 2870
*/ 
