...
package org . jfree . chart . renderer . xy  ;
 ...
 public  class GradientXYBarPainter implements XYBarPainter   , Serializable    { private   double   g1    ;
   private   double   g2    ;
   private   double   g3    ;
   public   GradientXYBarPainter ( )  { this   ( 0.10    , 0.20    , 0.80     )   ;
  }      public   GradientXYBarPainter ( double   g1   , double   g2   , double   g3    )  { this   . g1  = g1     ;
  this   . g2  = g2     ;
  this   . g3  = g3     ;
  }      @ Override      public   void paintBar ( Graphics2D   g2   , XYBarRenderer   renderer   , int   row   , int   column   , RectangularShape   bar   , RectangleEdge   base    )  { Paint   itemPaint  = renderer   . getItemPaint  ( row   , column    )      ;
  Color   c0   , c1     ;
  ...
  }     if ( ! ( obj   instanceof GradientXYBarPainter    )    )  { return false    ;
